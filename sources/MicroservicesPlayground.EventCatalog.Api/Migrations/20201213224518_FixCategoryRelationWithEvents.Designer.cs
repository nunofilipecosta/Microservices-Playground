...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MicroservicesPlayground.EventCatalog.Api.Entities.Category", b =>
                {
            ...
            modelBuilder.Entity("MicroservicesPlayground.EventCatalog.Api.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Artist = "John Egbert",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2021, 6, 13, 22, 45, 17, 917, DateTimeKind.Local).AddTicks(3073),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2021, 9, 13, 22, 45, 17, 920, DateTimeKind.Local).AddTicks(2868),
                        ...
                        new
                        {
                            ...
                            Artist = "DJ 'The Mike'",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2021, 4, 13, 22, 45, 17, 920, DateTimeKind.Local).AddTicks(2960),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2021, 4, 13, 22, 45, 17, 920, DateTimeKind.Local).AddTicks(2992),
                        ...
                        new
                        {
                            ...
                            Artist = "Many",
                            CategoryId = new Guid("fe98f549-e790-4e9f-aa16-18c2292a2ee9"),
                            Date = new DateTime(2021, 10, 13, 22, 45, 17, 920, DateTimeKind.Local).AddTicks(3018),
                        ...
                        new
                        {
                            ...
                            Artist = "Nick Sailor",
                            CategoryId = new Guid("6313179f-7837-473a-a4d5-a5571b43e6a6"),
                            Date = new DateTime(2021, 8, 13, 22, 45, 17, 920, DateTimeKind.Local).AddTicks(3051),
            ...
            modelBuilder.Entity("MicroservicesPlayground.EventCatalog.Api.Entities.Event", b =>
                {
                    b.HasOne("MicroservicesPlayground.EventCatalog.Api.Entities.Category", "Category")
                        .WithMany("Events")
