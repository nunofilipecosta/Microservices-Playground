...
using MicroservicesPlayground.EventCatalog.Api.EntityConfiguration;
using Microsoft.EntityFrameworkCore;
using System;

namespace MicroservicesPlayground.EventCatalog.Api.DbContexts
{
    public class EventCatalogDbContext : DbContext
    {
        ...
        public EventCatalogDbContext(DbContextOptions<EventCatalogDbContext> dbContextOptions) : base(dbContextOptions)
        {
        }
